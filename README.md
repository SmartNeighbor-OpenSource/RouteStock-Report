...
1. # <a name="_heading=h.iv3t72wpl8ge"></a>**Capítulo I: Introducción**
   ...
   1. ## <a name="_heading=h.cef4nj5tp5jz"></a> **Startup Profile**
      ...
      1. ### <a name="_heading=h.u8z3eha1kjlr"></a>**Descripción de la Startup**
         ...
         Nuestro proyecto consiste en una plataforma digital orientada a bodegas, pequeños comercios locales y vendedores ambulantes, con el objetivo de facilitar la búsqueda de productos cercanos por parte de los usuarios. La propuesta surge ante la dificultad que muchas personas tienen para encontrar rápidamente lo que necesitan en su zona, así como por la baja digitalización de los pequeños negocios, que muchas veces no cuentan con medios para mostrar su inventario en línea. A través de esta plataforma, los comercios pueden registrar y actualizar sus productos disponibles, mientras que los clientes pueden consultar qué artículos se encuentran cerca de su ubicación, comparar opciones y acceder a una compra más rápida y práctica. Además, la integración de vendedores ambulantes y la optimización de rutas para delivery aportan un valor diferencial, ya que amplían la oferta disponible y mejoran la eficiencia en la entrega. De esta manera, se construye una solución que beneficia tanto a los negocios locales, al darles mayor visibilidad, como a los consumidores, al brindarles acceso ágil a productos de su entorno.

         Misión: Brindar una solución digital accesible e innovadora que conecte a los usuarios con bodegas, comercios locales y vendedores ambulantes cercanos, facilitando la búsqueda de productos y promoviendo la digitalización de los pequeños negocios. Buscamos generar una experiencia práctica, rápida y útil tanto para los vendedores como para los consumidores.

         Visión: Aspiramos a convertirnos en la plataforma líder en el Perú para la búsqueda y acceso a productos de comercios locales cercanos. Queremos ser reconocidos por impulsar la transformación digital de pequeños negocios, integrar nuevos modelos de venta y mejorar la experiencia de compra mediante tecnología, cercanía y eficiencia en el servicio.
